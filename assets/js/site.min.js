...
var site=site||{};site.helpers=function(t){"use strict";var n=function(t,n){var e,a=!1,r=function(){var i=random(-1*n,n),o=random(-1*n,n);t.css("transform","perspective(600px) rotateY("+i+"deg) rotateX("+o+"deg)"),a===!0&&(e=setTimeout(function(){r(t,n)},random(3e3,5e3)))},i=function(){var n=0,e=0;t.css("transform","perspective(600px) rotateY("+n+"deg) rotateX("+e+"deg)")},o=function(){a=!1,clearTimeout(e),i()},s=function(){a=!0,r()};return{stop:o,play:s}},e=function(n){var e=function(n){var e=[],a=n.find("thead th"),r=n.find("tbody tr");t.each(a,function(){e.push(t(this).text())}),t.each(r,function(){var n=0;t.each(t(this).find("td"),function(){t(this).attr("data-th",e[n]),t(this).find("> *").wrapAll("<div></div>"),n++})}),""!=e[0]&&n.addClass("featured")};t.each(n,function(){e(t(this))})},a=function(){return t(".main-section").outerHeight()},r=function(n,e,a){t.ajax({type:n.attr("method"),url:n.attr("action"),data:n.serialize(),dataType:"json",success:function(t){"success"===t.status?e&&e(t):a(t)},error:function(t,n,e){a(t.responseJSON)}})};return{changeRotation:n,mobileTable:e,mainSectionHeight:a,formPost:r}}(jQuery),random=function(t,n){return Math.floor(Math.random()*(n-t+1)+t)};
var site=site||{};site.contactForm=function(s){"use strict";s("#contact-form").bind("submit",function(t){t.preventDefault();var a=s(this),e=a.find(".message"),r=function(s,t){var a=e.attr("data-class");e.removeClass(a),e.addClass(s),e.attr("data-class",s),e.html(t),e.show()};site.helpers.formPost(a,function(s){r("success",s.data.message)},function(s){r("error",s.message)})})}(jQuery);
var site=site||{};site.newsletter=function(s){"use strict";s(".newsletter-subscribe").bind("submit",function(t){t.preventDefault();var e=s(this),r=e.find(".response"),n=function(s,t){var e=r.attr("data-class");r.removeClass(e),r.addClass(s),r.attr("data-class",s),r.html(t),r.show()};site.helpers.formPost(e,function(s){n("success","Thank you for subscribing!")},function(s){n("error",s.message)})})}(jQuery);
var site=site||{};site.navigation=function(e){"use strict";var n=e("#site-header .mobil-menu-btn"),t=e("#cd-lateral-nav"),a=(t.attr("data-site-url"),t.attr("data-page-url"),120);jQuery.extend(jQuery.easing,{easeInOutExpo:function(e,n,t,a,s){return 0==n?t:n==s?t+a:(n/=s/2)<1?a/2*Math.pow(2,10*(n-1))+t:a/2*(-Math.pow(2,-10*--n)+2)+t}});var s=function(e,n,t){var a=1500;void 0==t&&(t="swing"),e.stop().animate({scrollTop:n},a,t,function(){})},i=function(n){e(window).width()<750&&(a=20),s(e("body, html"),e(n).offset().top-a,"easeInOutExpo")};e(document).ready(function(){var t=n,a=e(".site-main"),s=e(".site-header, .site-footer");e("#cd-lateral-nav").addClass("ready"),t.on("click",function(n){n.preventDefault(),t.toggleClass("is-clicked"),s.toggleClass("lateral-menu-is-open"),a.toggleClass("lateral-menu-is-open").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){e("body").toggleClass("overflow-hidden")}),e("#cd-lateral-nav").toggleClass("lateral-menu-is-open"),e("html").hasClass("no-csstransitions")&&e("body").toggleClass("overflow-hidden")}),a.on("click",function(n){e(n.target).is("#cd-menu-trigger, #cd-menu-trigger span")||o()});var o=function(){t.removeClass("is-clicked"),s.removeClass("lateral-menu-is-open"),a.removeClass("lateral-menu-is-open").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){e("body").removeClass("overflow-hidden")}),e("#cd-lateral-nav").removeClass("lateral-menu-is-open"),e("html").hasClass("no-csstransitions")&&e("body").removeClass("overflow-hidden")};e(".item-has-children").children("a").on("click",function(n){n.preventDefault(),e(this).toggleClass("submenu-open").next(".sub-menu").slideToggle(200).end().parent(".item-has-children").siblings(".item-has-children").children("a").removeClass("submenu-open").next(".sub-menu").slideUp(200)}),e("a[href=#contact]").bind("click",function(e){e.preventDefault(),i("#contact"),o()})})}(jQuery);
var site=site||{};site.overlayVideo=function(e){"use strict";function i(){var i=40,o=e(".video-wrapper iframe");o.height(e(window).height()-2*i),o.width(e(window).width()-2*i)}function o(){var i=e(".video-wrapper iframe"),o=i.attr("src");i.attr("src",o)}var n=e("#videoOverlay");e("#show-video").on("click",function(o){o.preventDefault(),e("body").addClass("video-overlay-open"),n.fadeIn(),i(),e(window).bind("resize.video",function(){i()})}),n.on("click",function(i){i.preventDefault(),n.fadeOut(function(){e("body").removeClass("video-overlay-open"),o()}),e(window).unbind("resize.video")})}(jQuery);
var site=site||{};site.main=function(e){"use strict";var t=750;isMobile.any?e("html").addClass("mobile"):e("html").addClass("no-mobile"),isMobile.phone?e("html").addClass("phone"):e("html").addClass("no-phone");var a=(e("body").attr("data-page-type"),e("body").attr("data-bg-type"));if(site.helpers.mobileTable(e(".table-wrapper table")),e("html").hasClass("no-mobile")&&(site.helpers.changeRotation(e(".newsletter-box"),20).play(),site.helpers.changeRotation(e(".tickets-box"),20).play(),site.helpers.changeRotation(e(".home-after-polygon-1"),20).play(),site.helpers.changeRotation(e(".home-after-polygon-2"),20).play(),site.helpers.changeRotation(e(".home-after-polygon-3"),20).play()),!Modernizr.touch){skrollr.init()}return e(".fancybox").fancybox(),e.each(e("select"),function(){e('<div class="select-wrapper"></div>').insertBefore(e(this)).html(this)}),{mediumScreen:t,bgType:a}}(jQuery);
var site=site||{};site.background=function(t){"use strict";var n=function(n,a){var o,r=[],e=function(){o=Snap(n);for(var t=0;t<a.shapes.length;t++)"shape"===a.shapes[t].type?r[t]=new i(a.shapes[t]):"image"===a.shapes[t].type&&(r[t]=new s(a.shapes[t]))},i=function(t){var n=[],a=t.cords(),r=f(a),e=function(){var n=f(t.cords()),a=random(t.animate.from,t.animate.to);t.polygons&&m.animate({d:n},a,mina.easeinout,function(){}),i.animate({d:n},a,mina.easeinout,function(){e()})},i=o.path(r).attr({fill:t.background}),s="t"+t.position.left+" "+t.position.top;if(i.transform(s),t.polygons){var m=o.path(r).attr({fill:"white"});m.transform(s);for(var p=o.group(i),d=0;d<t.polygons.length;d++)n[d]=new l(t.polygons[d]),p.add(n[d]);p.attr({mask:m})}t.animate.enable&&e()},s=function(t){var n=null,a=null;void 0!=t.size&&(void 0!=t.size.width&&(n=t.size.width),void 0!=t.size.height&&(a=t.size.height));var r=o.path(f(t.mask())).attr({fill:"white"}),e=o.image(o.node.getAttribute(t.image),0,0,n,a),i="t"+t.position.left+" "+t.position.top;return e.transform(i),e.attr({mask:r}),e},l=function(t){var n,a=[],r=t.offset,e=function(t){return[[random(350-t,350+t),random(0-t,0+t)],[random(695-t,695+t),random(255-t,255+t)],[random(560-t,560+t),random(660-t,660+t)],[random(130-t,130+t),random(660-t,660+t)],[random(0-t,0+t),random(250-t,250+t)]]},i=function(n){for(var r=0;r<n.length;r++)a[r]=o.circle(n[r][0],n[r][1],3).attr({fill:t.color,opacity:.6})},s=e(r);n=o.path(f(s)).attr({fill:"transparent",stroke:t.color,opacity:.6}),i(s);for(var l=o.group(n),m=0;m<a.length;m++)l.add(a[m]);var p="t"+t.position.left+" "+t.position.top;return l.transform(p),l},f=function(t,n,a){var o="";if(n)for(var r=0;r<=t.length;r++)0==r?o+="M "+random(t[r][0]-a,t[r][0]+a)+" "+random(t[r][1]-a,t[r][1]+a):r>0&&r<t.length?o+=" L "+random(t[r][0]-a,t[r][0]+a)+" "+random(t[r][1]-a,t[r][1]+a):r==t.length&&(o+=" Z");else for(var r=0;r<=t.length;r++)0==r?o+="M "+t[r][0]+" "+t[r][1]:r>0&&r<t.length?o+=" L "+t[r][0]+" "+t[r][1]:r==t.length&&(o+=" Z");return o};return t(n).length&&e(),o};return{TopBg:n}}(jQuery);
var homeBgConfig={shapes:[{type:"image",image:"data-picture",position:{top:0,left:1131},mask:function(){return[[0,0],[850,0],[850,620],[240,620],[0,480]]}},{type:"shape",background:"l(0, 0, 1, 0)#ffc210-#c9165c-#e36b56",position:{top:0,left:0},animate:{enable:!1,from:1e4,to:2e4},cords:function(){return[[280,0],[2050,0],[2050,153],[random(1550,1700),random(0,30)],[1131,480],[0,site.helpers.mainSectionHeight()]]},polygons:[{offset:100,color:"#d5d4cd",position:{top:0,left:100},animationTime:{from:1e4,to:4e4}},{offset:100,color:"#d5d4cd",position:{top:-100,left:900},animationTime:{from:8e3,to:24e3}}]},{type:"shape",background:"l(1, 1, 0, 1)#5f287e-#2d2d85",position:{top:-150,left:1300},animate:{enable:!1,from:15e3,to:4e4},cords:function(){return[[770,0],[770,1400],[0,729],[random(350,450),random(450,550)]]},polygons:[{offset:80,color:"#d5d4cd",position:{top:500,left:1550},animationTime:{from:1e4,to:4e4}}]}]},venueBgConfig={shapes:[{type:"image",image:"data-picture",position:{top:0,left:900},size:{width:1265,height:800},mask:function(){return[[0,0],[1170,0],[1170,800],[427,600],[220,site.helpers.mainSectionHeight()+30],[31,site.helpers.mainSectionHeight()+30]]}},{type:"shape",background:"l(1, 0, 0, 1)#e72b63-#ee673c",position:{top:0,left:0},animate:{enable:!1,from:1e4,to:2e4},cords:function(){return[[280,0],[2070,0],[2070,153],[$(window).width<1150?1e3:random(1750,1800),random(-30,0)],[random(1250,1400),random(250,280)],[931,site.helpers.mainSectionHeight()+30],[0,random(site.helpers.mainSectionHeight()-10,site.helpers.mainSectionHeight()+20)]]},polygons:[{offset:100,color:"#d5d4cd",position:{top:-100,left:0},animationTime:{from:1e4,to:4e4}},{offset:100,color:"#d5d4cd",position:{top:50,left:1100},animationTime:{from:8e3,to:24e3}}]},{type:"shape",background:"l(1, 1, 0, 1)#9be0c2-#6cb79e",position:{top:0,left:1300},animate:{enable:!1,from:15e3,to:4e4},cords:function(){return[[770,450],[770,1050],[26,600],[random(350,450),random(550,650)]]},polygons:[{offset:50,color:"#d5d4cd",position:{top:500,left:1550},animationTime:{from:1e4,to:4e4}}]}]},defaultBgConfig=function(e){return{shapes:[{type:"shape",background:e,position:{top:0,left:0},animate:{enable:!1,from:1e4,to:2e4},cords:function(){return[[147,0],[2092,0],[2166,680],[random(1e3,1300),random(site.helpers.mainSectionHeight()-10,site.helpers.mainSectionHeight()+50)],[0,site.helpers.mainSectionHeight()-20]]},polygons:[{offset:100,color:"#d5d4cd",position:{top:50,left:300},animationTime:{from:1e4,to:4e4}},{offset:100,color:"#d5d4cd",position:{top:-150,left:1550},animationTime:{from:8e3,to:24e3}}]}]}},blueHeaderBgConfig=defaultBgConfig("l(0, 0, 1, 0)#2d2d85-#1065af"),purpleGreenHeaderBgConfig=defaultBgConfig("l(0, 0, 0.8, 0)#ffc310-#d33959"),purpleBlueHeaderBgConfig=defaultBgConfig("l(0, 0, 0.8, 0.2)#224295-#66277d"),purplePinkHeaderBgConfig=defaultBgConfig("l(0.2, 0.5, 0.8, 0.8)#5c267d-#c70f5c"),redPurpleHeaderBgConfig=defaultBgConfig("l(0.4, 0, 0.8, 0.8)#ffc310-#d74459"),purpleHeaderBgConfig=defaultBgConfig("l(0.3, 0, 0.8, 0.8)#5c267d-#d241d9"),orangeHeaderBgConfig=defaultBgConfig("l(0, 0, 0.8, 0.8)#fdb912-#e36c56"),headerBgInited=!1,resizeTimeout,siteHeaderBg,headerBgInit=function(e){switch(headerBgInited=!0,e){case"home":siteHeaderBg=new site.background.TopBg("#main-section-bg",homeBgConfig);break;case"venue":siteHeaderBg=new site.background.TopBg("#main-section-bg",venueBgConfig);break;case"blue":siteHeaderBg=new site.background.TopBg("#main-section-bg",blueHeaderBgConfig);break;case"purple-green":siteHeaderBg=new site.background.TopBg("#main-section-bg",purpleGreenHeaderBgConfig);break;case"purple-blue":siteHeaderBg=new site.background.TopBg("#main-section-bg",purpleBlueHeaderBgConfig);break;case"purple-pink":siteHeaderBg=new site.background.TopBg("#main-section-bg",purplePinkHeaderBgConfig);break;case"red-purple":siteHeaderBg=new site.background.TopBg("#main-section-bg",redPurpleHeaderBgConfig);break;case"purple":siteHeaderBg=new site.background.TopBg("#main-section-bg",purpleHeaderBgConfig);break;case"orange":siteHeaderBg=new site.background.TopBg("#main-section-bg",orangeHeaderBgConfig);break;default:siteHeaderBg=new site.background.TopBg("#main-section-bg",blueHeaderBgConfig)}};$(window).width()>=site.main.mediumScreen&&!$("html").hasClass("phone")&&headerBgInit(site.main.bgType),isMobile.any?isMobile.phone||$(window).bind("orientationchange",function(e){$(this);clearTimeout(resizeTimeout),resizeTimeout=setTimeout(function(){headerBgInited&&siteHeaderBg.clear(),headerBgInit(site.main.bgType)},500)}):$(window).bind("resize",function(e){$(this);clearTimeout(resizeTimeout),resizeTimeout=setTimeout(function(){$(window).width()>=site.main.mediumScreen&&(headerBgInited&&siteHeaderBg.clear(),headerBgInit(site.main.bgType))},500)});